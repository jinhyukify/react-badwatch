...
class UserDetailBox extends React.Component {
    ...
    render() {
    	...
    	if(this.props.quick_mode)
    	{
    		userDetailBox = (
    			<div>
    				{/*<UserDetailCard data={winRate(userData.quick_win, userData.quick_game_count)} img={"win-rate-icon"}>승률</UserDetailCard>*/}
    		...
    		userMobileDetailBox = (
    				<div>
    					{/*<UserMobileDetailCard data={winRate(userData.quick_win, userData.quick_game_count)} img={"win-rate-icon"}>승률</UserMobileDetailCard>*/}
        		...
        		<div>
        			...
        			<div className="col s12 l8">
        				<div className="hero-info mobile-hide">
        					...
        					<span className="hero-head-win middle-big-hide">{this.props.quick_mode? "승리": "승률(%)"}</span>
